...
///////////////////////////////////////////////
	public void findNextWithSelection() {
		...
		if (idx != -1) {
			...
			JOptionPane.showMessageDialog(this, "Cannot find" + " \"" + findWhat.getText()
...
//check if the selected text matches the search text then do replacement
		...
		if ((matchCase.isSelected() && temp.equals(searchText)) || (!matchCase.isSelected()
				&& temp.equalsIgnoreCase(searchText)))
